<?php
/*
Plugin Name: Fullscreen Slit Slider
Plugin URI: http://www.monovoce.com
Description: Front Page Fullscreen Slit Slider
...
class My_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			'My_Widget', // Base ID
			__('Fullscreen Slit Slider', 'text_domain'), // Name
